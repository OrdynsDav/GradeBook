    ...
    <View style={[styles.container, containerStyle]}>
      ...
      <View
        style={[
          ...
          { borderColor, backgroundColor: theme.colors.background.paper },
        ]}
      >
        {leftIcon && (
          <Ionicons
      ...
      {error && <Text style={[styles.error, { color: theme.colors.status.error }]}>{error}</Text>}
      {hint && !error && <Text style={[styles.hint, { color: theme.colors.text.secondary }]}>{hint}</Text>}
    </View>
  );
};
